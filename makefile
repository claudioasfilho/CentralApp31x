...
-I$(SDK_DIR)/app/bluetooth/common_host/tcp \
-I$(SDK_DIR)/app/bluetooth/common_host/system \
-I$(SDK_DIR)/app/bluetooth/common_host/app_assert \
-I$(SDK_DIR)/app/bluetooth/common_host/app_log \
...
ifeq ($(OS),win)
# NOTE: -lWs2_32 is needed for proper WinSock compilation
